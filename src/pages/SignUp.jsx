    ...
    instance.post('/auth/signUp', signUpData)
      ...
      .catch(error => {
        if (error.response) {
          ...
          if (msg.includes('id') || msg.includes('아이디')) {
      ...
      <div className="signup-box">
        ...
        <form onSubmit={signUpHandler}>
          <div className="form-group">
            <label className="form-label" htmlFor="id">아이디 <span className="label-hint">(영문 소문자 + 숫자, 5~20자)</span></label>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="password">비밀번호 <span className="label-hint">(영문, 숫자, 특수문자 포함 8~20자)</span></label>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="memberName">이름 <span className="label-hint">(2~20자, 한글 또는 영문)</span></label>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="nickname">닉네임 <span className="label-hint">(한글/영문/숫자 조합, 2~20자 <span style={{fontWeight:400}}>(선택)</span>)</span></label>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="email">이메일 <span className="label-hint">(예: example@domain.com)</span></label>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="phoneNumber">휴대폰 번호 <span className="label-hint">(예: 01012345678)</span></label>
