...
import RegisterMentoring from '../pages/Mentoring/RegisterMentoring';
import RegisterCancel from '../pages/Mentoring/RegisterCancel';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/mentoring/register" element={<RegisterMentoring />} />
        <Route path="/mentoring/cancel" element={<RegisterCancel />} />
